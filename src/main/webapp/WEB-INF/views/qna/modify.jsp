...
<html>
	<head>
        ...
        <body onload="init();">
                ...
                <form method="post" class="code_write" action="/qna/modify">
                        <input name="qb_no" value="${post.qb_no}" style="display: none">
                        <div class="write_top">
                                <div class="code_write_title" style="padding:0px">
                                        <input type="text" name="qb_title" placeholder="제목" value="${post.qb_title}">
                                </div>	
                        </div>
			<div>	
                                <div style="margin-top: 20px;" >
                                        <textarea name="qb_text" id="writebody" style="height:200px;" placeholder="내용" >${post.qb_text}</textarea>
				</div>
				<br />
			</div>
