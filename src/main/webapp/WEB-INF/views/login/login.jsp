	...
	<div>
		<div class="form">
			<ul class="tab-group">
				...
				<li class="tab">
					<a id="regi" href="#forgot" >ID/PASSWORD 찾기</a>
				</li>
			</ul>
			<div class="tab-content">
					...
					<form action="/login/register" method="post" id="regifrm">
						<div class="top-row">
							<div class="field-wrap">
								...
								<input type="text" id="idcheck" name="mem_id" autocomplete="off" style="width:440px;ime-mode:disabled" onkeyup="trim(this);">
						...
						<div class="field-wrap">
							...
							<input type="text" id="emailcheck" name="mem_email" autocomplete="off" style="width:440px;ime-mode:disabled" onkeyup="trim(this);">
						...
						<div class="field-wrap">
								...
								<input type="password" id="regipw" name="mem_pw" autocomplete="off" style="ime-mode:disabled" onkeyup="trim(this);"/>
						</div>
						<div class="field-wrap">
								<label>비밀번호 확인
									<span class="req">*</span>
						...
						<div class="field-wrap">
								...
								<input type="text" id="reginame" name="mem_name" autocomplete="off" style="ime-mode:desativated" onkeyup="trim(this);"/>
						</div>
				...
				<div id="forgot">
					<h1>ID찾기</h1>
					<form action="/idfind" method="post" id="idfrm">
						<div class="field-wrap">
							<label >이름
									<span class="req">*</span>
							</label>
							<input type="text" id="findname" name="mem_id" autocomplete="off" onkeyup="trim(this);"/>
						</div>
						<div class="field-wrap">
							<label>이메일
								<span class="req">*</span>
							</label>
							<input type="text" id="findemail" name="mem_email" autocomplete="off" style="ime-mode:disabled" onkeyup="trim(this);"/>
						</div>
	...
	<script>
		...
		$('#idfind').click(function(){ //아이디찾기
			...
			$.ajax({
			    ...
			    type : "POST",
			    dataType:"json",
			    data : {mem_name:$("#findname").val(),mem_email:$("#findemail").val()},
			    success : function(response){
			    	if(!response.result){
						...
						$("#idfrm")[0].reset();
                                                ...
                                                $(".tab-group").children().eq(2).addClass('active')
					}
					else{
		...
		$('#pwfind').click(function(){ //비밀번호찾기
			...
			$.ajax({
			    ...
			    type : "POST",
                            dataType:"json",
                            data:{mem_name:$("#pwfindname").val(),mem_id:$("#pwfindid").val(),mem_email:$("#pwfindemail").val()},
			    success : function(response){
			    	if(!response.result){
                                        alert("일치하는 계정정보가 없습니다");
                                        $('#pwfind').css("background-color","#3f8be9");
